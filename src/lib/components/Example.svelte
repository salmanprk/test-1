<script lang="ts">
    ...
    let scale = 1; // Default scale is 1 (100% size)

    // Function to adjust the scale dynamically
    function adjustScale() {
        const baseWidth = 1500; // The width where the scale is 100%
    ...
    // Use the onMount lifecycle function to add event listener
    onMount(() => {
        adjustScale(); // Call it once on initial mount

        // Add resize event listener to adjust the scale dynamically
...
<!-- <div
    class="p-8 bg-gray-100 border-2 border-gray-800"
    style="transform: scale({scale}); transform-origin: top left;"
> -->
<!-- <h1 class="text-3xl font-bold mb-4">Scalable Component</h1>
  <p class="text-lg">This entire component scales dynamically as the window width changes.</p> -->

<div class="grid w-full grid-cols-12">
    <div class="bg-muted/40 hidden border-r md:block col-span-3">
